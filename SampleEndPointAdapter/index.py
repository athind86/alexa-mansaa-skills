...
def handler(request, context):
    ...
    try:
        ...
        print("Pehla Log::1 ", request)
        print("Dusra Log::2 ", env_client_secret)
        print("Teesra Log::3 ", get_api_url(env_api_id, env_aws_default_region, 'auth-redirect'))
        ...
        if http_method == 'POST' and resource == '/directives':
            ...
            response_name = json.loads(response.body)
